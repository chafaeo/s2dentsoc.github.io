...
include './inc/nav.php';
 ...
 $query2 = $db->query("SELECT * FROM `account` WHERE `type_id` = 2");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="panel" style="background-color: #2bbc60;color: white;">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <i><img src="<?php echo BASE_URL;?>admin/img/verified_student.png" width="80px"></i>
                                    </div>
                            ...
                            <a style="color: #2f7fd8;" href="students/?v=y">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <i><img src="<?php echo BASE_URL;?>admin/img/unregistered_student.png" width="80px"></i>
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $total; ?></div>
                                        <div>Unverified Students!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="students/?v=n">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <i><img src="<?php echo BASE_URL;?>admin/img/unverified_student.png" width="80px"></i>
                                    </div>
                                    <div class="col-xs-9 text-right">
